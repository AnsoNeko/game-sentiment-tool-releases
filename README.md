...
> v0.4.0 新增完整的作者资产与采买决策链路：作者中心、采买批次与交付、后台作品/画像分析、同平台评分趋势，以及面向约 500 位作者的严格预算采买推荐与 CSV/XLSX 导出。
...
1. 在最新 Release 页面下载 `GameSentimentTool-v0.4.0-win-x64-Setup.exe`。
2. v0.3.3-v0.3.5 用户可使用软件内更新升级到 v0.4.0。**v0.3.2 及更早版本必须手工下载 v0.4.0，并以管理员身份运行一次。** 旧版更新助手会在新的安装握手代码生效前自行退出，无法通过远端资源反向修复。
...
```text
2527833802B0FF99A6CFE2E845F3F4F48EA694FA8D73842C1D2CA30DD3D8EB70
```
