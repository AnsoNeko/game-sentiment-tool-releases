...
> v0.4.5 修正广泛监测候选准入：至少一个真实标签精确匹配才进入候选，未核验线索单列扫描历史。历史支持单条、跨页批量和按筛选移除，确认后不再重复加入；已有热度监测保持不变。
...
1. 在最新 Release 页面下载 `GameSentimentTool-v0.4.5-win-x64-Setup.exe`。
2. v0.3.3-v0.4.4 用户可通过软件内更新获取 v0.4.5；本次未执行真实安装/升级测试。**v0.3.2 及更早版本必须手工下载 v0.4.5，并以管理员身份运行一次。** 旧版更新助手会在新的安装握手代码生效前自行退出，无法通过远端资源反向修复。
...
```text
9DCB25FFBB397870C070E7D970F86EEDB78A93F2BFB621E35B88F4790F06FC6D
```
