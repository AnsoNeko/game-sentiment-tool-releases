...
> v0.3.1 新增反链数据采集与作者库，支持 B站、抖音、小红书主页按关键词和日期范围查找作品及公开互动指标；同时取消评论采集 300 条硬上限。2026-08-19 同版本刷新安装包，修复“重启并安装”退出后未完成升级的问题。

## 使用方式

1. 在最新 Release 页面下载 `GameSentimentTool-v0.3.1-win-x64-Setup.exe`。
2. 运行安装程序；检测到旧版本时会自动沿用原安装路径，全新安装使用默认目录。若旧版软件内“重启并安装”曾退出但没有升级，请右键安装包并选择“以管理员身份运行”完成这一次覆盖安装。
...
```text
48B1B375018923EE44ECBCB93090239C8A26FE73E39F2DA47100DED6CA9B9EAE
```
