...
> v0.4.2 新增反链持续采集、每轮 Windows/飞书结果推送，以及将所选反链链接合并预填到舆情指定链接采集的工作流。
...
1. 在最新 Release 页面下载 `GameSentimentTool-v0.4.2-win-x64-Setup.exe`。
2. v0.3.3-v0.4.1 用户可使用软件内更新升级到 v0.4.2。**v0.3.2 及更早版本必须手工下载 v0.4.2，并以管理员身份运行一次。** 旧版更新助手会在新的安装握手代码生效前自行退出，无法通过远端资源反向修复。
...
```text
76A636BCB6DBD9E540053238A67FEBD89BFC0BBA2D4F5FD78898871EDEABD9FE
```
