...
> v0.4.3 新增独立 B站广泛监测、评论业务风险分析与人工复核，并优化周报 AI 配置同步和长材料生成。广泛监测首次升级默认关闭。
...
1. 在最新 Release 页面下载 `GameSentimentTool-v0.4.3-win-x64-Setup.exe`。
2. v0.3.3-v0.4.2 用户可通过软件内更新获取 v0.4.3；本次未执行真实安装/升级测试。**v0.3.2 及更早版本必须手工下载 v0.4.3，并以管理员身份运行一次。** 旧版更新助手会在新的安装握手代码生效前自行退出，无法通过远端资源反向修复。
...
```text
CE603E1D90E33A2C00960F2ED35D71B6FB4CC97A501C8207DD3010214CD4AB29
```
