...
> v0.4.4 新增广泛扫描启停、预约与72小时以上期限、独立投稿范围和100条候选表格。候选即时可查、达标优先、推送可独立关闭，所有候选可手动入池。升级后全局扫描默认停止，请设置期限并主动开始。
...
1. 在最新 Release 页面下载 `GameSentimentTool-v0.4.4-win-x64-Setup.exe`。
2. v0.3.3-v0.4.3 用户可通过软件内更新获取 v0.4.4；本次未执行真实安装/升级测试。**v0.3.2 及更早版本必须手工下载 v0.4.4，并以管理员身份运行一次。** 旧版更新助手会在新的安装握手代码生效前自行退出，无法通过远端资源反向修复。
...
```text
29DC0D31B5249226CEDE73338DF50F4275710EB86D8DC3E72070010CAB069926
```
